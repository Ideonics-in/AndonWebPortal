...
namespace AndonPortal
{
    public partial class VHTStatus : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 1; i <= 26; i++)
            {
                ...
                if (i == 1 || i == 2 || i == 5 || i == 6 || i == 7
                    ||i == 8 || i == 15 || i== 16 || i== 19 || i == 21 || i == 25 || i == 26 )
                    continue;
                switch (i)
                {
                    case 1:
                        ...
                        displayStatus(VHT_1,"VHT 1", (int)dt.Rows[i-1]["Status"],
                            (startTs == null )? "":startTs.Value.ToString("dd-MMM-yyyy HH:mm:ss"));
                        break;
                    case 2:
        ...
        private void displayStatus(Button VHT, string vht, int p, string startTs)
        {
            String status = string.Empty;
            Color backcolor = Color.Black;
            switch(p)
            {
                case 0 : status = "CYCLE COMPLETE";
            ...
            VHT.Text = vht + Environment.NewLine + status + Environment.NewLine + ((startTs == "") ? "" : "Start Date : " + startTs);
