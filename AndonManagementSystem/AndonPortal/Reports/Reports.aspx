...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <table style="width: 100%;">
        <tr>
            <td></td>
            <td>
                <asp:Label ID="Label3" runat="server" Text="Report Type:" ForeColor="White"></asp:Label>
                &nbsp;<div>
                    <asp:RadioButtonList CssClass="fixed" ID="TypeSelection" runat="server" ForeColor="White" RepeatDirection="Horizontal"
                        OnSelectedIndexChanged="TypeSelection_SelectedIndexChanged" AutoPostBack="true">
            ...
            <td>
                <asp:Label ID="Label6" runat="server" Text="Line: " ForeColor="White"></asp:Label><br />
            ...
            <td>
                <div id="ShiftDiv" runat="server" visible="false">
                    <asp:Label runat="server" Text="No of Shifts:" ForeColor="White"></asp:Label>
                    <br />
                    <asp:TextBox ID="ShiftTextBox" runat="server" Width="100px" ></asp:TextBox>
                    <asp:RequiredFieldValidator ID="ShiftValidator" ControlToValidate="ShiftTextBox"
        ...
        <tr>
            ...
            <td>
                <asp:Calendar ID="FromDate" runat="server"
                    ...
                    NextPrevStyle-BackColor="Green" TitleStyle-BackColor="Green" TitleStyle-BorderColor="Green"></asp:Calendar>
            </td>
            <td>
                <div style="text-align: right">
